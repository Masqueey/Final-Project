...
rm -rf distances/feret/LDA_ldaSoft distances/feret/LDA_Euclidean
run mkdir -p distances/feret/LDA_ldaSoft distances/feret/LDA_Euclidean

# Projecting face images onto PCA basis and computing distances

run csuSubspaceProject -imDir data/FERET/normSep2002sfi train/feret/feretLDA.train imagelists/all.srt distances/feret/LDA_ldaSoft ldaSoft distances/feret/LDA_Euclidean Euclidean
