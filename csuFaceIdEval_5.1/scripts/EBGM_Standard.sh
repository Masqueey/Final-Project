...
###### End of PREAMBLE ######
msg "Running the standard CSU EBGM"
...
NOVEL_GRAPH_DIR="data/EBGM_Standard_NG"
NOVEL_IMAGE_LIST="imagelists/all.srt"
NOVEL_IMAGE_LIST_LO="imagelists/all.lo.srt"
NOVEL_IMAGE_LIST_HI="imagelists/all.hi.srt"
FACE_GRAPH_DIR="data/EBGM_Standard_FG"
FGPI_DIR="distances/feret/EBGM_Standard"

mkdir -p $NOVEL_GRAPH_DIR $FACE_GRAPH_DIR $FGPI_DIR
...
csuEBGMGraphFit $MODEL_LIST $NOVEL_IMAGE_LIST_LO $WAVELET $EBGM_SFI_DIR  $MODEL_GRAPH_DIR DEPredictiveIter $NOVEL_GRAPH_DIR &
csuEBGMGraphFit $MODEL_LIST $NOVEL_IMAGE_LIST_HI $WAVELET $EBGM_SFI_DIR  $MODEL_GRAPH_DIR DEPredictiveIter $NOVEL_GRAPH_DIR &
wait
...
csuEBGMMeasure $NOVEL_IMAGE_LIST $FACE_GRAPH_DIR FGPredictiveIter $FGPI_DIR
